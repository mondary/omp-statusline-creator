...
plus. `icon.png` (copie de `icon2.png`) est l'icône de l'app ; une copie est maintenue à la racine du dépôt (convention). `icon2b.png` est la source haute résolution.
